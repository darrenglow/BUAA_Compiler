...
**优化了之后一定要充分测试！！！优化到这里发现代码生成二不过了，通过逐个取消优化，发现到达定义分析有bug**
...
8 9 11 14 15 16 20 21 24 25 26 29
...
- 跳转语句如果刚好跳到的是下一跳，那么可以删除。
  ...
  所以中端的代码，如果跳转到的block只有一个前驱，才删除这个`JUMP`
...
- `JUMP_EQZ`中窥孔，有一个`sw`后接着`lw`。

- ![image-20231213210636581](./设计文档.assets/image-20231213210636581.png)
...
- `Test/zyg/testfile1.txt`
- 常量传播时的offset

![image-20231124124915580](./设计文档.assets/image-20231124124915580.png)

- 参数多了会寄 public/testfile75
